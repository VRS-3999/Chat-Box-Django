<template>
  <div class="container">
    <h1 class="text-center">Welcome to ChatBox</h1>
    <div id="auth-container" class="row">
      <div class="col-sm-4 offset-sm-4">
        <ul class='nav nav-tabs nav-justified' id="myTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="signup-tab" data-toogle="tab" href="#signup" role="tab" aria-controls="signup" aria-selected="true">
            Sign Up
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="signin-tab" data-toogle="tab" href="#signin" role="tab" aria-contrls="signin" aria-selected="false">
            Sign In
            </a>
          </li>
        </ul>
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="signin" role="tabpanel" aria-labelledby="sigin-tab">
